...
INSERT INTO Pacotes (NomePacote, Descricao, DataIda, DataVolta, Valor, NomeCidade, Situacao)
VALUES ('SALVADOR - 5 DIAS / 4 DIÁRIAS', 'O que não falta em Salvador são atrações. Prova disso são as praias,
os museus e as construções seculares que dão um charme mais que especial à região. A
...
'06/08/2020', '10/08/2020', '854.00', 'Salvador', 'Ativo'), 
...
Praia do Forte e Costa do Sauipe.', '14/05/2020', '18/05/2020', '1826.00', 'Salvador', 'Ativo'),
...
região.', '28/03/2020', '01/04/2020', '1004.00', 'Bonito', 'Ativo');
